...
global.tips = [[ // You can edit this!
        "Tip: You can view your keybinds in the options menu.",
        "Tip: You can play on mobile by just going to dreadio.glitch.me on your phone!"
    ], [
        "Tip: You can have the shield and health bar be separated by going to the options menu.",
        "Tip: If dread.io is having a low frame rate, you can try enabling low graphics in the options menu.",
